...
// get companies that 10years or more

// const lastedTenyears=companies.filter(company => (company.
//     end - company.start >= 10));
...
// sort cpompanies by start year 

// const sortedCompanies = companies.sort(function(){
